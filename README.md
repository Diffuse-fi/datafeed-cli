...
Proxy contract contains list of all pairs and storage addresses. CREATE2 insrtuction is used for deployment, therefore  and has predetermined address on all chains. Deployed only once.
